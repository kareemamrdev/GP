...
static void rate_monotonic_scheduler(void)
{
  ...
  if ((open_loop_inverter_model_bad_M->Timing.TaskCounters.TID[2]) > 1) {/* Sample time: [5.0E-5s, 2.5E-5s] */
...
void open_loop_inverter_model_badry_sus_step0(void) /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  frequency = open_loop_inverter_model_badr_P.Gain9_Gain *
    open_loop_inverter_model_badr_P.Constant_Value;

  /* Gain: '<S1>/Gain1' */
  ModulationIndexLimiter = open_loop_inverter_model_badr_P.Gain1_Gain *
    frequency;

  /* Saturate: '<S1>/Modulation Index Limiter' */
  if (ModulationIndexLimiter >
      open_loop_inverter_model_badr_P.ModulationIndexLimiter_UpperSat) {
    /* Saturate: '<S1>/Modulation Index Limiter' */
    ModulationIndexLimiter =
      open_loop_inverter_model_badr_P.ModulationIndexLimiter_UpperSat;
  } else if (ModulationIndexLimiter <
   ...
   *  Sum: '<S4>/Add1'
   */
  rtb_Add3 = look1_pbinlxpw(fmod(open_loop_inverter_model_bad_M->Timing.t[0] +
   ...
   */
  rtb_Add3 -= open_loop_inverter_model_badr_P.Constant2_Value;
   ...
   *  Fcn: '<S1>/C-Phase'
   */
  frequency = 6.2831853071795862 * frequency *
   ...
   */
  rtb_Gain8 = sin(frequency) * ModulationIndexLimiter > rtb_Add3 ?
   ...
   */
  rtb_Gain8 = sin(frequency - 2.0943951023931953) * ModulationIndexLimiter >
    rtb_Add3 ? open_loop_inverter_model_badr_P.Gain1_Gain_j : 0U;
   ...
   */
  rtb_Gain8 = sin(frequency - 4.1887902047863905) * ModulationIndexLimiter >
    rtb_Add3 ? open_loop_inverter_model_badr_P.Gain8_Gain : 0U;
...
void open_loop_inverter_model_badry_sus_step2(void) /* Sample time: [5.0E-5s, 2.5E-5s] */
{
...
void open_loop_inverter_model_badry_sus_initialize(void)
{
  ...
  open_loop_inverter_model_bad_M->Timing.stepSize0 = 2.5E-5;

  /* initialize sample time offsets */
  open_loop_inverter_model_bad_M->Timing.TaskCounters.TID[2] = 1;/* Sample time: [5.0E-5s, 2.5E-5s] */
