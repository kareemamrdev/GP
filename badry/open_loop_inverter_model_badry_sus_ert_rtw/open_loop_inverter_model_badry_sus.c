 ...
 * C/C++ source code generated on : Sat May 10 16:53:01 2025
 *
...
void open_loop_inverter_model_badry_sus_step(void)
{
   ...
   */
  if (!(++open_loop_inverter_model_bad_M->Timing.clockTick0)) {
    ++open_loop_inverter_model_bad_M->Timing.clockTickH0;
  }

  open_loop_inverter_model_bad_M->Timing.taskTime0 =
    open_loop_inverter_model_bad_M->Timing.clockTick0 *
    open_loop_inverter_model_bad_M->Timing.stepSize0 +
    open_loop_inverter_model_bad_M->Timing.clockTickH0 *
    open_loop_inverter_model_bad_M->Timing.stepSize0 * 4294967296.0;
}
...
void open_loop_inverter_model_badry_sus_initialize(void)
{
  ...
  open_loop_inverter_model_bad_M->Timing.stepSize0 = 1.0E-6;

  /* External mode info */
  open_loop_inverter_model_bad_M->Sizes.checksums[0] = (255905044U);
  open_loop_inverter_model_bad_M->Sizes.checksums[1] = (1235503920U);
  open_loop_inverter_model_bad_M->Sizes.checksums[2] = (3505793724U);
  open_loop_inverter_model_bad_M->Sizes.checksums[3] = (1110426959U);
