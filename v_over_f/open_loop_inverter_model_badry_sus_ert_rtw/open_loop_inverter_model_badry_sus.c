...
void open_loop_inverter_model_badry_sus_step(void)
{
   ...
   *  Gain: '<Root>/Gain11'
   */
  open_loop_inverter_model_badr_B.Fcn3 =
    (open_loop_inverter_model_badr_P.Gain11_Gain *
     open_loop_inverter_model_badr_P.Constant3_Value * sin
     (open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator3_DSTATE) + 1.0) *
    5000.0;
  ...
  {
    EPwm1Regs.CMPA.bit.CMPA = (uint16_T)(open_loop_inverter_model_badr_B.Fcn3);
  }

  /* Fcn: '<Root>/Fcn4' incorporates:
   *  Constant: '<Root>/Constant4'
   *  DiscreteIntegrator: '<Root>/Discrete-Time Integrator4'
   *  Fcn: '<Root>/Fcn7'
   *  Gain: '<Root>/Gain12'
   */
  rtb_Fcn5 = (open_loop_inverter_model_badr_P.Gain12_Gain *
              open_loop_inverter_model_badr_P.Constant4_Value * sin
              (open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator4_DSTATE -
               2.0943951023931953) + 1.0) * 5000.0;

  /* S-Function (c2802xpwm): '<Root>/ePWM4' */

  /*-- Update CMPA value for ePWM2 --*/
  {
    EPwm2Regs.CMPA.bit.CMPA = (uint16_T)(rtb_Fcn5);
  }

  /* Fcn: '<Root>/Fcn5' incorporates:
   *  Constant: '<Root>/Constant5'
   *  DiscreteIntegrator: '<Root>/Discrete-Time Integrator5'
   *  Fcn: '<Root>/Fcn8'
   *  Gain: '<Root>/Gain13'
   */
  rtb_Fcn5 = (open_loop_inverter_model_badr_P.Gain13_Gain *
              open_loop_inverter_model_badr_P.Constant5_Value * sin
              (open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator5_DSTATE +
               2.0943951023931953) + 1.0) * 5000.0;

  /* S-Function (c2802xpwm): '<Root>/ePWM5' */

  /*-- Update CMPA value for ePWM3 --*/
  {
    EPwm3Regs.CMPA.bit.CMPA = (uint16_T)(rtb_Fcn5);
  }
   ...
   *  Gain: '<Root>/Gain15'
   */
  open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator3_DSTATE +=
    open_loop_inverter_model_badr_P.Gain15_Gain *
    open_loop_inverter_model_badr_P.Constant3_Value *
    open_loop_inverter_model_badr_P.DiscreteTimeIntegrator3_gainval;

  /* Update for DiscreteIntegrator: '<Root>/Discrete-Time Integrator4' incorporates:
   *  Constant: '<Root>/Constant4'
   *  Gain: '<Root>/Gain14'
   */
  open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator4_DSTATE +=
    open_loop_inverter_model_badr_P.Gain14_Gain *
    open_loop_inverter_model_badr_P.Constant4_Value *
    open_loop_inverter_model_badr_P.DiscreteTimeIntegrator4_gainval;

  /* Update for DiscreteIntegrator: '<Root>/Discrete-Time Integrator5' incorporates:
   *  Constant: '<Root>/Constant5'
   *  Gain: '<Root>/Gain16'
   */
  open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator5_DSTATE +=
    open_loop_inverter_model_badr_P.Gain16_Gain *
    open_loop_inverter_model_badr_P.Constant5_Value *
    open_loop_inverter_model_badr_P.DiscreteTimeIntegrator5_gainval;
...
void open_loop_inverter_model_badry_sus_initialize(void)
{
  ...
  open_loop_inverter_model_bad_M->Timing.stepSize0 = 0.2;

  /* External mode info */
  open_loop_inverter_model_bad_M->Sizes.checksums[0] = (801277190U);
  open_loop_inverter_model_bad_M->Sizes.checksums[1] = (2182139748U);
  open_loop_inverter_model_bad_M->Sizes.checksums[2] = (3892567733U);
  open_loop_inverter_model_bad_M->Sizes.checksums[3] = (1988809659U);
  ...
  /* Start for S-Function (c2802xpwm): '<Root>/ePWM5' */
  ...
  open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator3_DSTATE =
    open_loop_inverter_model_badr_P.DiscreteTimeIntegrator3_IC;

  /* InitializeConditions for DiscreteIntegrator: '<Root>/Discrete-Time Integrator4' */
  open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator4_DSTATE =
    open_loop_inverter_model_badr_P.DiscreteTimeIntegrator4_IC;

  /* InitializeConditions for DiscreteIntegrator: '<Root>/Discrete-Time Integrator5' */
  open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator5_DSTATE =
    open_loop_inverter_model_badr_P.DiscreteTimeIntegrator5_IC;
}
