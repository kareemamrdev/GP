  ...
  *eventFlags)
{
  ...
  eventFlags[1] = ((boolean_T)rtmStepTask(open_loop_inverter_model_bad_M, 1));
}
...
static void rate_monotonic_scheduler(void)
{
   ...
   */
  (open_loop_inverter_model_bad_M->Timing.TaskCounters.TID[1])++;
  if ((open_loop_inverter_model_bad_M->Timing.TaskCounters.TID[1]) > 9) {/* Sample time: [0.001s, 0.0s] */
    open_loop_inverter_model_bad_M->Timing.TaskCounters.TID[1] = 0;
  }
}

/* Model step function for TID0 */
void open_loop_inverter_model_badry_sus_step0(void) /* Sample time: [0.0001s, 0.0s] */
{
   ...
   */
  open_loop_inverter_model_bad_M->Timing.taskTime0 =
    ((time_T)(++open_loop_inverter_model_bad_M->Timing.clockTick0)) *
    open_loop_inverter_model_bad_M->Timing.stepSize0;
}

/* Model step function for TID1 */
void open_loop_inverter_model_badry_sus_step1(void) /* Sample time: [0.001s, 0.0s] */
{
  real_T rtb_Gain1;
  real_T rtb_Gain8;

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn' */
  open_loop_inverter_model_badr_B.DiscreteTransferFcn =
    open_loop_inverter_model_badr_P.DiscreteTransferFcn_NumCoef *
    open_loop_inverter_model_bad_DW.DiscreteTransferFcn_states;
  ...
  /* S-Function (c2802xadc): '<Root>/ADC' */
  {
    ...
    open_loop_inverter_model_badr_B.ADC = (AdcbResultRegs.ADCRESULT0);
  }
  ...
  /* S-Function (c2802xadc): '<Root>/ADC1' */
  {
    ...
    open_loop_inverter_model_badr_B.ADC1 = (AdccResultRegs.ADCRESULT0);
  }
  ...
  /* S-Function (c2802xadc): '<Root>/ADC2' */
  {
    ...
    open_loop_inverter_model_badr_B.ADC2 = (AdcaResultRegs.ADCRESULT0);
  }

  /* Saturate: '<Root>/Saturation' incorporates:
   *  Constant: '<Root>/Constant1'
   */
  if (open_loop_inverter_model_badr_P.Constant1_Value >
      open_loop_inverter_model_badr_P.Saturation_UpperSat) {
    rtb_Gain8 = open_loop_inverter_model_badr_P.Saturation_UpperSat;
  } else if (open_loop_inverter_model_badr_P.Constant1_Value <
             open_loop_inverter_model_badr_P.Saturation_LowerSat) {
    rtb_Gain8 = open_loop_inverter_model_badr_P.Saturation_LowerSat;
  } else {
    rtb_Gain8 = open_loop_inverter_model_badr_P.Constant1_Value;
  }
   ...
   *  Fcn: '<Root>/Fcn'
   */
  open_loop_inverter_model_badr_B.Gain = (0.5 * rtb_Gain8 * sin
    (open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator_DSTATE) + 0.5) *
    open_loop_inverter_model_badr_P.Gain_Gain;
  ...
  /*-- Update CMPA value for ePWM1 --*/
  {
    EPwm1Regs.CMPA.bit.CMPA = (uint16_T)((uint32_T)EPwm1Regs.TBPRD *
      open_loop_inverter_model_badr_B.Gain * 0.01);
  }
   ...
   *  Fcn: '<Root>/Fcn2'
   */
  rtb_Gain8 = (0.5 * rtb_Gain8 * sin
               (open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator_DSTATE -
                2.0943951023931953) + 0.5) *
    open_loop_inverter_model_badr_P.Gain8_Gain;

  /* S-Function (c2802xpwm): '<Root>/ePWM2' */

  /*-- Update CMPA value for ePWM3 --*/
  {
    EPwm3Regs.CMPA.bit.CMPA = (uint16_T)((uint32_T)EPwm3Regs.TBPRD * rtb_Gain8 *
      0.01);
  }

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn1' */
  open_loop_inverter_model_badr_B.DiscreteTransferFcn1 =
    open_loop_inverter_model_badr_P.DiscreteTransferFcn1_NumCoef *
    open_loop_inverter_model_bad_DW.DiscreteTransferFcn1_states;

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn2' */
  open_loop_inverter_model_badr_B.DiscreteTransferFcn2 =
    open_loop_inverter_model_badr_P.DiscreteTransferFcn2_NumCoef *
    open_loop_inverter_model_bad_DW.DiscreteTransferFcn2_states;
   ...
   */
  open_loop_inverter_model_bad_DW.DiscreteTransferFcn_states =
    ((open_loop_inverter_model_badr_P.Gain3_Gain *
      open_loop_inverter_model_badr_B.ADC -
      open_loop_inverter_model_badr_P.Constant_Value) *
     open_loop_inverter_model_badr_P.Gain4_Gain -
     open_loop_inverter_model_badr_P.DiscreteTransferFcn_DenCoef[1L] *
     open_loop_inverter_model_bad_DW.DiscreteTransferFcn_states) /
    open_loop_inverter_model_badr_P.DiscreteTransferFcn_DenCoef[0];
   ...
   */
  open_loop_inverter_model_bad_DW.DiscreteTimeIntegrator_DSTATE +=
    open_loop_inverter_model_badr_P.Gain2_Gain *
    open_loop_inverter_model_badr_P.Constant1_Value *
   ...
   */
  open_loop_inverter_model_bad_DW.DiscreteTransferFcn1_states =
    ((open_loop_inverter_model_badr_P.Gain5_Gain *
      open_loop_inverter_model_badr_B.ADC1 -
      open_loop_inverter_model_badr_P.Constant2_Value) *
     open_loop_inverter_model_badr_P.Gain6_Gain -
     open_loop_inverter_model_badr_P.DiscreteTransferFcn1_DenCoef[1L] *
     open_loop_inverter_model_bad_DW.DiscreteTransferFcn1_states) /
    open_loop_inverter_model_badr_P.DiscreteTransferFcn1_DenCoef[0];

  /* Update for DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn2' incorporates:
   ...
   */
  open_loop_inverter_model_bad_DW.DiscreteTransferFcn2_states =
    ((open_loop_inverter_model_badr_P.Gain7_Gain *
      open_loop_inverter_model_badr_B.ADC2 -
      open_loop_inverter_model_badr_P.Constant3_Value) *
     open_loop_inverter_model_badr_P.Gain9_Gain -
     open_loop_inverter_model_badr_P.DiscreteTransferFcn2_DenCoef[1L] *
     open_loop_inverter_model_bad_DW.DiscreteTransferFcn2_states) /
    open_loop_inverter_model_badr_P.DiscreteTransferFcn2_DenCoef[0];
...
void open_loop_inverter_model_badry_sus_initialize(void)
{
  ...
  open_loop_inverter_model_bad_M->Timing.stepSize0 = 0.0001;

  /* External mode info */
  open_loop_inverter_model_bad_M->Sizes.checksums[0] = (4158932659U);
  open_loop_inverter_model_bad_M->Sizes.checksums[1] = (3472967351U);
  open_loop_inverter_model_bad_M->Sizes.checksums[2] = (1610799781U);
  open_loop_inverter_model_bad_M->Sizes.checksums[3] = (723182303U);
  ...
  open_loop_inverter_model_bad_DW.DiscreteTransferFcn_states =
    open_loop_inverter_model_badr_P.DiscreteTransferFcn_InitialStat;
  ...
  open_loop_inverter_model_bad_DW.DiscreteTransferFcn1_states =
    open_loop_inverter_model_badr_P.DiscreteTransferFcn1_InitialSta;

  /* InitializeConditions for DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn2' */
  open_loop_inverter_model_bad_DW.DiscreteTransferFcn2_states =
    open_loop_inverter_model_badr_P.DiscreteTransferFcn2_InitialSta;
}
