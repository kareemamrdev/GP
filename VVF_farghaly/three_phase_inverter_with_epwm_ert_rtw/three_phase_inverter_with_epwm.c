...
static void rate_monotonic_scheduler(void)
{
  ...
  if ((three_phase_inverter_with_ep_M->Timing.TaskCounters.TID[1]) > 1) {/* Sample time: [0.0002s, 0.0s] */
    three_phase_inverter_with_ep_M->Timing.TaskCounters.TID[1] = 0;
  }
}

/* Model step function for TID0 */
void three_phase_inverter_with_epwm_step0(void) /* Sample time: [0.0001s, 0.0s] */
{
