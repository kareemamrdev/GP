...
static void rate_monotonic_scheduler(void)
{
  ...
  if ((untitled1_M->Timing.TaskCounters.TID[1]) > 9) {/* Sample time: [0.0001s, 0.0s] */
    untitled1_M->Timing.TaskCounters.TID[1] = 0;
  }
}

/* Model step function for TID0 */
void untitled1_step0(void)             /* Sample time: [1.0E-5s, 0.0s] */
{
...
void untitled1_step1(void)             /* Sample time: [0.0001s, 0.0s] */
{
  real_T T0;
  real_T Tb;
  real_T rtb_Gain2;
  ...
  /* SampleTimeMath: '<S1>/Sample Time Math' incorporates:
   ...
   *  y = u * K where K = ( w * Ts )
   *   */
  rtb_Gain2 = (real_T)untitled1_DW.Output_DSTATE *
    untitled1_P.SampleTimeMath_WtEt;

  /* Lookup_n-D: '<S1>/Lookup' incorporates:
   *  Gain: '<Root>/Gain2'
   */
  rtb_Gain2 = look1_binlcpw(rtb_Gain2,
    untitled1_P.RepeatingSequenceInterpolated_m,
    untitled1_P.RepeatingSequenceInterpolated3_, 1UL);

  /* MATLAB Function: '<S2>/MATLAB Function' */
  if ((rtb_Gain2 >= 0.0) && (rtb_Gain2 <= 1.0471975511965976)) {
    rtb_y = 1;
  } else if ((rtb_Gain2 >= 1.0471975511965976) && (rtb_Gain2 <=
              2.0943951023931953)) {
    rtb_y = 2;
  } else if ((rtb_Gain2 >= 2.0943951023931953) && (rtb_Gain2 <=
              3.1415926535897931)) {
    rtb_y = 3;
  } else if ((rtb_Gain2 >= 3.1415926535897931) && (rtb_Gain2 <=
              4.1887902047863905)) {
    rtb_y = 4;
  } else if ((rtb_Gain2 >= 4.1887902047863905) && (rtb_Gain2 <=
              5.2359877559829888)) {
    rtb_y = 5;
  } else {
    rtb_y = 6;
  ...
  /* Math: '<S2>/Power' incorporates:
   *  Constant: '<Root>/Constant1'
   *
   * About '<S2>/Power':
   *  Operator: reciprocal
   */
  rtb_Power = 1.0 / untitled1_P.Constant1_Value;

  /* MATLAB Function: '<S3>/MATLAB Function1' incorporates:
   *  Constant: '<Root>/Constant'
   *  MATLAB Function: '<S2>/MATLAB Function'
   */
  Tb = rtb_Gain2 - ((real_T)rtb_y - 1.0) * 1.0471975511965976;
  rtb_a3 = rtb_Power * untitled1_P.Constant_Value;
  rtb_Gain2 = sin(1.0471975511965976 - Tb) * rtb_a3;
  Tb = sin(Tb) * rtb_a3;
  T0 = (rtb_Power - rtb_Gain2) - Tb;
  switch (rtb_y) {
   case 1:
    rtb_a1 = T0 / 4.0 / (rtb_Gain2 / 2.0);
    T0 = T0 / 4.0 + rtb_Gain2 / 2.0;
    rtb_a3 = T0 / (rtb_Gain2 / 2.0);
    rtb_Power = (Tb / 2.0 + T0) / (rtb_Gain2 / 2.0);
    break;

   case 2:
    rtb_a3 = T0 / 4.0 / (rtb_Gain2 / 2.0);
    T0 = T0 / 4.0 + rtb_Gain2 / 2.0;
    rtb_a1 = T0 / (rtb_Gain2 / 2.0);
    rtb_Power = (Tb / 2.0 + T0) / (rtb_Gain2 / 2.0);
    break;
   ...
   case 3:
    rtb_a3 = T0 / 4.0 / (rtb_Gain2 / 2.0);
    T0 = T0 / 4.0 + rtb_Gain2 / 2.0;
    rtb_Power = T0 / (rtb_Gain2 / 2.0);
    rtb_a1 = (Tb / 2.0 + T0) / (rtb_Gain2 / 2.0);
    break;

   case 4:
    rtb_Power = T0 / 4.0 / (rtb_Gain2 / 2.0);
    T0 = T0 / 4.0 + rtb_Gain2 / 2.0;
    rtb_a3 = T0 / (rtb_Gain2 / 2.0);
    rtb_a1 = (Tb / 2.0 + T0) / (rtb_Gain2 / 2.0);
    break;
   ...
   case 5:
    ...
    T0 = T0 / 4.0 + rtb_Gain2 / 2.0;
    rtb_a1 = T0 / (rtb_Gain2 / 2.0);
    rtb_a3 = (Tb / 2.0 + T0) / (rtb_Gain2 / 2.0);
    break;
  ...
  /* Gain: '<Root>/Gain' */
  rtb_Gain2 = untitled1_P.Gain_Gain * rtb_a1;

  /* S-Function (c2802xpwm): '<Root>/ePWM' */

  /*-- Update CMPA value for ePWM1 --*/
  {
    EPwm1Regs.CMPA.bit.CMPA = (uint16_T)((uint32_T)EPwm1Regs.TBPRD * rtb_Gain2 *
      0.01);
  }

  /* Gain: '<Root>/Gain1' */
  rtb_Gain2 = untitled1_P.Gain1_Gain * rtb_a3;

  /* S-Function (c2802xpwm): '<Root>/ePWM1' */

  /*-- Update CMPA value for ePWM2 --*/
  {
    EPwm2Regs.CMPA.bit.CMPA = (uint16_T)((uint32_T)EPwm2Regs.TBPRD * rtb_Gain2 *
      0.01);
  }

  /* Gain: '<Root>/Gain2' */
  rtb_Gain2 = untitled1_P.Gain2_Gain * rtb_Power;

  /* S-Function (c2802xpwm): '<Root>/ePWM2' */

  /*-- Update CMPA value for ePWM3 --*/
  {
    EPwm3Regs.CMPA.bit.CMPA = (uint16_T)((uint32_T)EPwm3Regs.TBPRD * rtb_Gain2 *
      0.01);
  }
   ...
   *  UnitDelay: '<S4>/Output'
   */
  untitled1_DW.Output_DSTATE = (untitled1_DW.Output_DSTATE +
    untitled1_P.FixPtConstant_Value) & 255U;

  /* Switch: '<S6>/FixPt Switch' incorporates:
   *  Constant: '<S6>/Constant'
   *  Sum: '<S5>/FixPt Sum1'
   */
  if (untitled1_DW.Output_DSTATE > untitled1_P.WrapToZero_Threshold) {
    untitled1_DW.Output_DSTATE = untitled1_P.Constant_Value_d;
  }
...
void untitled1_initialize(void)
{
  ...
  /* InitializeConditions for Sum: '<S5>/FixPt Sum1' incorporates:
   *  UnitDelay: '<S4>/Output'
   */
