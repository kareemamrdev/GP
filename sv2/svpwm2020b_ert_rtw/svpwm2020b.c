...
#include "svpwm2020b.h"
#include <math.h>
#include "rt_nonfinite.h"
#include "rtwtypes.h"
#include "svpwm2020b_private.h"
#include <string.h>

/* Block signals (default storage) */
B_svpwm2020b_T svpwm2020b_B;

/* Block states (default storage) */
DW_svpwm2020b_T svpwm2020b_DW;

/* Real-time model */
static RT_MODEL_svpwm2020b_T svpwm2020b_M_;
RT_MODEL_svpwm2020b_T *const svpwm2020b_M = &svpwm2020b_M_;

/* Model step function */
void svpwm2020b_step(void)
{
  real_T rtb_Gain[3];
  real_T rtb_Add1;
  real_T rtb_Add3;
  ...
  /* Sin: '<Root>/Sine Wave' */
  svpwm2020b_B.SineWave = sin(((real_T)svpwm2020b_DW.counter +
    svpwm2020b_P.SineWave_Offset) * 2.0 * 3.1415926535897931 /
    svpwm2020b_P.SineWave_NumSamp) * svpwm2020b_P.SineWave_Amp +
    svpwm2020b_P.SineWave_Bias;

  /* Gain: '<S8>/Ka' */
  rtb_Add3 = svpwm2020b_P.Ka_Gain * svpwm2020b_B.SineWave;

  /* Gain: '<S8>/one_by_two' */
  rtb_Max = svpwm2020b_P.one_by_two_Gain * svpwm2020b_B.SineWave;

  /* Sin: '<Root>/Sine Wave1' */
  svpwm2020b_B.SineWave1 = sin(((real_T)svpwm2020b_DW.counter_h +
    svpwm2020b_P.SineWave1_Offset) * 2.0 * 3.1415926535897931 /
    svpwm2020b_P.SineWave1_NumSamp) * svpwm2020b_P.SineWave1_Amp +
    svpwm2020b_P.SineWave1_Bias;

  /* Gain: '<S8>/sqrt3_by_two' */
  rtb_Kc = svpwm2020b_P.sqrt3_by_two_Gain * svpwm2020b_B.SineWave1;

  /* Gain: '<S8>/Kb' incorporates:
   *  Sum: '<S8>/add_b'
   */
  rtb_Add1 = (rtb_Kc - rtb_Max) * svpwm2020b_P.Kb_Gain;

  /* Gain: '<S8>/Kc' incorporates:
   *  Sum: '<S8>/add_c'
   */
  rtb_Kc = ((0.0 - rtb_Max) - rtb_Kc) * svpwm2020b_P.Kc_Gain;

  /* MinMax: '<S5>/Max' incorporates:
   *  MinMax: '<S5>/Min'
   */
  tmp = rtIsNaN(rtb_Add1);
  if ((rtb_Add3 >= rtb_Add1) || tmp) {
    rtb_Max = rtb_Add3;
  } else {
    rtb_Max = rtb_Add1;
  }
   ...
   *  Sum: '<S5>/Add'
   */
  rtb_Max = (rtb_Max + y) * svpwm2020b_P.one_by_two_Gain_j;
   ...
   *  Sum: '<S4>/Add3'
   */
  svpwm2020b_B.Gain[0] = (rtb_Add3 + rtb_Max) * svpwm2020b_P.Gain_Gain;
  svpwm2020b_B.Gain[1] = (rtb_Add1 + rtb_Max) * svpwm2020b_P.Gain_Gain;
  svpwm2020b_B.Gain[2] = (rtb_Max + rtb_Kc) * svpwm2020b_P.Gain_Gain;

  /* Gain: '<Root>/One_by_Two' */
  svpwm2020b_B.One_by_Two[0] = svpwm2020b_P.One_by_Two_Gain * svpwm2020b_B.Gain
    [0];
  svpwm2020b_B.One_by_Two[1] = svpwm2020b_P.One_by_Two_Gain * svpwm2020b_B.Gain
    [1];
  svpwm2020b_B.One_by_Two[2] = svpwm2020b_P.One_by_Two_Gain * svpwm2020b_B.Gain
    [2];

  /* Sum: '<Root>/Sum' incorporates:
   *  Constant: '<Root>/Shifting UP'
   */
  svpwm2020b_B.PWM_Duty_Cycles[0] = svpwm2020b_B.One_by_Two[0] +
    svpwm2020b_P.ShiftingUP_Value;
  svpwm2020b_B.PWM_Duty_Cycles[1] = svpwm2020b_B.One_by_Two[1] +
    svpwm2020b_P.ShiftingUP_Value;
  svpwm2020b_B.PWM_Duty_Cycles[2] = svpwm2020b_B.One_by_Two[2] +
    svpwm2020b_P.ShiftingUP_Value;

  /* Gain: '<Root>/Gain' */
  rtb_Gain[0] = svpwm2020b_P.Gain_Gain_c * svpwm2020b_B.PWM_Duty_Cycles[0];
  rtb_Gain[1] = svpwm2020b_P.Gain_Gain_c * svpwm2020b_B.PWM_Duty_Cycles[1];
  rtb_Gain[2] = svpwm2020b_P.Gain_Gain_c * svpwm2020b_B.PWM_Duty_Cycles[2];

  /* S-Function (c2802xpwm): '<Root>/ePWM' */

  /*-- Update CMPA value for ePWM1 --*/
  {
    EPwm1Regs.CMPA.bit.CMPA = (uint16_T)(rtb_Gain[0]);
  }
  ...
  {
    EPwm2Regs.CMPA.bit.CMPA = (uint16_T)(rtb_Gain[1]);
  }
  ...
  {
    EPwm3Regs.CMPA.bit.CMPA = (uint16_T)(rtb_Gain[2]);
  }

  /* Update for Sin: '<Root>/Sine Wave' */
  svpwm2020b_DW.counter++;
  if (svpwm2020b_DW.counter == svpwm2020b_P.SineWave_NumSamp) {
    svpwm2020b_DW.counter = 0L;
  }

  /* End of Update for Sin: '<Root>/Sine Wave' */

  /* Update for Sin: '<Root>/Sine Wave1' */
  svpwm2020b_DW.counter_h++;
  if (svpwm2020b_DW.counter_h == svpwm2020b_P.SineWave1_NumSamp) {
    svpwm2020b_DW.counter_h = 0L;
  }
   ...
   */
  svpwm2020b_M->Timing.taskTime0 =
    ((time_T)(++svpwm2020b_M->Timing.clockTick0)) *
    svpwm2020b_M->Timing.stepSize0;
}

/* Model initialize function */
void svpwm2020b_initialize(void)
{
  /* Registration code */
  ...
  (void) memset((void *)svpwm2020b_M, 0,
                sizeof(RT_MODEL_svpwm2020b_T));
  rtmSetTFinal(svpwm2020b_M, 1.0);
  svpwm2020b_M->Timing.stepSize0 = 0.001;

  /* External mode info */
  svpwm2020b_M->Sizes.checksums[0] = (3176837733U);
  svpwm2020b_M->Sizes.checksums[1] = (3998944960U);
  svpwm2020b_M->Sizes.checksums[2] = (1991391534U);
  svpwm2020b_M->Sizes.checksums[3] = (2910094244U);

  {
    static const sysRanDType rtAlwaysEnabled = SUBSYS_RAN_BC_ENABLE;
    static RTWExtModeInfo rt_ExtModeInfo;
    static const sysRanDType *systemRan[1];
    svpwm2020b_M->extModeInfo = (&rt_ExtModeInfo);
    rteiSetSubSystemActiveVectorAddresses(&rt_ExtModeInfo, systemRan);
    systemRan[0] = &rtAlwaysEnabled;
    rteiSetModelMappingInfoPtr(svpwm2020b_M->extModeInfo,
      &svpwm2020b_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(svpwm2020b_M->extModeInfo, svpwm2020b_M->Sizes.checksums);
    rteiSetTPtr(svpwm2020b_M->extModeInfo, rtmGetTPtr(svpwm2020b_M));
  }

  /* block I/O */
  (void) memset(((void *) &svpwm2020b_B), 0,
                sizeof(B_svpwm2020b_T));

  /* states (dwork) */
  (void) memset((void *)&svpwm2020b_DW, 0,
                sizeof(DW_svpwm2020b_T));
  ...
  /*** Initialize ePWM1 modules ***/
  {
    ...
    EPwm1Regs.TBPRD = 6667U;           // Time Base Period Register
    ...
    EPwm1Regs.CMPA.bit.CMPA = 6667U;   // Counter Compare A Register
    EPwm1Regs.CMPB.bit.CMPB = 6667U;   // Counter Compare B Register
    ...
    /*	// Dead-Band Generator Control Register
       EPwm1Regs.DBCTL.bit.OUT_MODE             = 2U;          // Dead Band Output Mode Control
     ...
     */
    EPwm1Regs.DBCTL.all = (EPwm1Regs.DBCTL.all & ~0x8FFFU) | 0x2U;
  ...
  /*** Initialize ePWM2 modules ***/
  {
     ...
     */
    EPwm2Regs.TBCTL.all = (EPwm2Regs.TBCTL.all & ~0x3FFFU) | 0x2016U;
    EPwm2Regs.TBCTL2.all = (EPwm2Regs.TBCTL2.all & ~0xC000U) | 0x0U;

    /*-- Setup Time-Base (TB) Submodule --*/
    EPwm2Regs.TBPRD = 6667U;           // Time Base Period Register
    ...
    EPwm2Regs.CMPA.bit.CMPA = 6667U;   // Counter Compare A Register
    EPwm2Regs.CMPB.bit.CMPB = 6667U;   // Counter Compare B Register
    ...
    /*-- Setup Dead-Band Generator (DB) Submodule --*/
    /*	// Dead-Band Generator Control Register
       EPwm2Regs.DBCTL.bit.OUT_MODE             = 2U;          // Dead Band Output Mode Control
       EPwm2Regs.DBCTL.bit.IN_MODE              = 0U;          // Dead Band Input Select Mode Control
       EPwm2Regs.DBCTL.bit.POLSEL               = 0U;          // Polarity Select Control
     ...
     */
    EPwm2Regs.DBCTL.all = (EPwm2Regs.DBCTL.all & ~0x8FFFU) | 0x2U;
    EPwm2Regs.DBRED.bit.DBRED = (uint16_T)(0.0);
                         // Dead-Band Generator Rising Edge Delay Count Register
  ...
  /*** Initialize ePWM3 modules ***/
  {
     ...
     */
    EPwm3Regs.TBCTL.all = (EPwm3Regs.TBCTL.all & ~0x3FFFU) | 0x2016U;
    EPwm3Regs.TBCTL2.all = (EPwm3Regs.TBCTL2.all & ~0xC000U) | 0x0U;

    /*-- Setup Time-Base (TB) Submodule --*/
    EPwm3Regs.TBPRD = 6667U;           // Time Base Period Register
    ...
    EPwm3Regs.CMPA.bit.CMPA = 6667U;   // Counter Compare A Register
    EPwm3Regs.CMPB.bit.CMPB = 6667U;   // Counter Compare B Register
    ...
    /*-- Setup Dead-Band Generator (DB) Submodule --*/
    /*	// Dead-Band Generator Control Register
       EPwm3Regs.DBCTL.bit.OUT_MODE             = 2U;          // Dead Band Output Mode Control
     ...
     */
    EPwm3Regs.DBCTL.all = (EPwm3Regs.DBCTL.all & ~0x8FFFU) | 0x2U;
    EPwm3Regs.DBRED.bit.DBRED = (uint16_T)(0.0);
                         // Dead-Band Generator Rising Edge Delay Count Register
...
void svpwm2020b_terminate(void)
{
