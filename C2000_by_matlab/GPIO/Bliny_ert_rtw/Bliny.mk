###########################################################################
## Makefile generated for component 'Bliny'. 
## 
## Makefile     : Bliny.mk
## Generated on : Wed Apr 02 11:17:38 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Bliny.out
...
START_DIR                 = D:/Projects/GP/C2000_by_matlab
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Bliny.out
...
DEFINES_STANDARD = -DMODEL=Bliny -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/Bliny_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Bliny_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Bliny_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Bliny_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/Bliny_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/Bliny_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Bliny.obj : $(START_DIR)/Bliny_ert_rtw/Bliny.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Bliny_data.obj : $(START_DIR)/Bliny_ert_rtw/Bliny_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/Bliny_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
