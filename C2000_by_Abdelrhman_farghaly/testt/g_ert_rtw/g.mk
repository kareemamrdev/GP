###########################################################################
## Makefile generated for component 'g'. 
## 
## Makefile     : g.mk
## Generated on : Fri Feb 28 18:44:05 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/g.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/g.out
...
DEFINES_STANDARD = -DMODEL=g -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/g_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/g_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/g_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/g_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/g_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/g_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/g_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


g.obj : $(START_DIR)/g_ert_rtw/g.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


g_data.obj : $(START_DIR)/g_ert_rtw/g_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
