###########################################################################
## Makefile generated for component 'test_2'. 
## 
## Makefile     : test_2.mk
## Generated on : Fri Feb 28 20:51:30 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test_2.out
...
START_DIR                 = D:/Projects/GP/test_2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test_2.out
...
DEFINES_STANDARD = -DMODEL=test_2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/test_2_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/test_2_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/test_2_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/test_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/test_2_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/test_2_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/test_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


test_2.obj : $(START_DIR)/test_2_ert_rtw/test_2.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


test_2_data.obj : $(START_DIR)/test_2_ert_rtw/test_2_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
