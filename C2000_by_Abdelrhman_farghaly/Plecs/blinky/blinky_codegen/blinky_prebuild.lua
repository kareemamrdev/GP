...
local function checkCGTVersion()
  local cgt_install_dir = 'G:/1.More Apps/Plexim/cgt/ti-cgt-c2000_22.6.1.LTS'
  local min_version = '22.6.0'
  local cgt_version_file = 'D:/Projects/GP/C2000_by_Abdelrhman_farghaly/Plecs/blinky/blinky_codegen/TI2837xS_cpu1_cgt_version.txt'
...
if ok then 
  ...
  error("\n%s" % {U.stripTraceOrRethrowError(res)}, 0) -- must use error to halt execution of build here.
end
