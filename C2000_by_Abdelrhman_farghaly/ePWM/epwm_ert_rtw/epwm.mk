###########################################################################
## Makefile generated for component 'epwm'. 
## 
## Makefile     : epwm.mk
## Generated on : Fri Feb 28 22:07:54 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/epwm.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/epwm.out
...
DEFINES_STANDARD = -DMODEL=epwm -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/epwm_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/epwm_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/epwm_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/epwm_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/epwm_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/epwm_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/epwm_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


epwm.obj : $(START_DIR)/epwm_ert_rtw/epwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


epwm_data.obj : $(START_DIR)/epwm_ert_rtw/epwm_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/epwm_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
