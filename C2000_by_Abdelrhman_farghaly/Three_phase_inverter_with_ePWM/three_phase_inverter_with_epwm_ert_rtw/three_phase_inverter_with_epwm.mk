...
PRODUCT_NAME              = three_phase_inverter_with_epwm
MAKEFILE                  = three_phase_inverter_with_epwm.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/three_phase_inverter_with_epwm.out
...
%.obj : $(START_DIR)/three_phase_inverter_with_epwm_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/three_phase_inverter_with_epwm_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/three_phase_inverter_with_epwm_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/three_phase_inverter_with_epwm_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_board.obj : $(START_DIR)/three_phase_inverter_with_epwm_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
three_phase_inverter_with_epwm.obj : $(START_DIR)/three_phase_inverter_with_epwm_ert_rtw/three_phase_inverter_with_epwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


three_phase_inverter_with_epwm_data.obj : $(START_DIR)/three_phase_inverter_with_epwm_ert_rtw/three_phase_inverter_with_epwm_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
