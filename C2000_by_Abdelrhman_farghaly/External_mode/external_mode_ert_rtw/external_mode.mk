###########################################################################
## Makefile generated for component 'external_mode'. 
## 
## Makefile     : external_mode.mk
## Generated on : Fri Feb 28 21:08:40 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/external_mode.out
...
PRODUCT_NAME              = external_mode
MAKEFILE                  = external_mode.mk
MATLAB_ROOT               = G:/Matlab/Matlab
MATLAB_BIN                = G:/Matlab/Matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/Projects/GP/External_mode
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/external_mode.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/external_mode_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IG:/DSP/C2000Ware/C2000Ware_5_04_00_00/libraries/calibration/hrpwm/f2837xd/include -IG:/DSP/C2000Ware/C2000Ware_5_04_00_00/driverlib/f2837xd/driverlib -IG:/DSP/C2000Ware/C2000Ware_5_04_00_00/driverlib/f2837xd/driverlib/inc -IG:/DSP/C2000Ware/C2000Ware_5_04_00_00/device_support/f2837xd/common/include -IG:/DSP/C2000Ware/C2000Ware_5_04_00_00/device_support/f2837xd/headers/include -IG:/DSP/C2000Ware/C2000Ware_5_04_00_00/device_support/f2837xd/common -IG:/DSP/C2000Ware/C2000Ware_5_04_00_00/libraries/math/IQmath/c28/include -IG:/DSP/C2000Ware/C2000Ware_5_04_00_00/libraries/math/CLAmath/c28/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc
...
DEFINES_STANDARD = -DMODEL=external_mode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/external_mode_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/external_mode_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/external_mode_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/external_mode_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/external_mode_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/external_mode_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/external_mode_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


external_mode.obj : $(START_DIR)/external_mode_ert_rtw/external_mode.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


external_mode_data.obj : $(START_DIR)/external_mode_ert_rtw/external_mode_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
