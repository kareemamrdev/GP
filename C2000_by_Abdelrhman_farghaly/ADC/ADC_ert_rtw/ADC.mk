###########################################################################
## Makefile generated for component 'ADC'. 
## 
## Makefile     : ADC.mk
## Generated on : Tue Mar 04 06:22:22 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ADC.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ADC.out
...
DEFINES_STANDARD = -DMODEL=ADC -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/ADC_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ADC_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ADC_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ADC_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/ADC_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/ADC_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ADC.obj : $(START_DIR)/ADC_ert_rtw/ADC.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ADC_data.obj : $(START_DIR)/ADC_ert_rtw/ADC_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/ADC_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/ADC_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
